...
String serverPath = "https://api.openweathermap.org/data/2.5/weather?lat=20.6024&lon=-103.2714&appid=dd29bb3c378785f0ff34c3586f52ef7d&units=metric"; //El path que usaste en el web para la tem de la API - TODO el path con http
// ThingSpeak
uint32_t channelNumber = 2481116; // Tu channel ID number de thingspeak
const char *writeAPIKey = "F5Z4OQQ7FDD69HD6"; // El API write de thingspeak
void setup()
{
Serial.begin(115200);
dht.begin();
...
int code = ThingSpeak.writeFields(2481116, "F5Z4OQQ7FDD69HD6");
if(code == 200)
